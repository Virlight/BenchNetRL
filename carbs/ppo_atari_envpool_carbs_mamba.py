...
def run_experiment(params):
    ...
    csv_file = "carbs_runs_atari_mamba.csv"
...
if __name__ == "__main__":
    param_spaces = [
        ...
        Param(
            name="seq_len",
            space=LogSpace(min=2, max=16, is_integer=True),
            search_center=8,
        ),
        Param(
            name="d_state",
            space=LogSpace(min=8, max=32, is_integer=True),
            search_center=16,
        ),
        Param(
            name="d_conv",
            space=LogSpace(min=2, max=4, is_integer=True),
            search_center=3,
        ),
        Param(
            name="expand",
            space=LogSpace(min=1, max=4, is_integer=True),
            search_center=2,
        ),
        Param(
            name="hidden_dim",
            space=LogSpace(min=64, max=384, is_integer=True),
            search_center=256,
        ),
    ]
    ...
    state_filename = "carbs_atari_state_mamba.pkl"
